...
class WithTrackItemRequestBuilder(BaseRequestBuilder):
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/videos/{videoId}/audio-tracks/{trackId}", path_parameters)
    ...
    async def delete(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[AudioTrackDelete]:
        ...
        return await self.request_adapter.send_async(request_info, AudioTrackDelete, error_mapping)
