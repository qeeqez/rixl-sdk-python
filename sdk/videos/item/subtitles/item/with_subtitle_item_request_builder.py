...
class WithSubtitleItemRequestBuilder(BaseRequestBuilder):
    """
    ...
    def __init__(self,request_adapter: RequestAdapter, path_parameters: Union[str, dict[str, Any]]) -> None:
        ...
        Returns: None
        """
        super().__init__(request_adapter, "{+baseurl}/videos/{videoId}/subtitles/{subtitleId}", path_parameters)
    ...
    async def delete(self,request_configuration: Optional[RequestConfiguration[QueryParameters]] = None) -> Optional[SubtitleDelete]:
        ...
        return await self.request_adapter.send_async(request_info, SubtitleDelete, error_mapping)
    ...
    def with_url(self,raw_url: str) -> WithSubtitleItemRequestBuilder:
        """
        ...
        return WithSubtitleItemRequestBuilder(self.request_adapter, raw_url)
    
    @dataclass
    class WithSubtitleItemRequestBuilderDeleteRequestConfiguration(RequestConfiguration[QueryParameters]):
        """
